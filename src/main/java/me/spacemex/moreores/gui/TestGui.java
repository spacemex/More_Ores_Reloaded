...
package me.spacemex.moreores.gui;
...
import me.spacemex.moreores.procedures.LolProcedure;
...
public class TestGui extends MoreoresModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public TestGui(MoreoresModElements instance) {
		super(instance, 64);
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				MoreoresMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
