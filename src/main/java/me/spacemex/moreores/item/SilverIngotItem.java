...
public class SilverIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:silver_ingot")
	public static final Item block = null;
	public SilverIngotItem(MoreoresModElements instance) {
		super(instance, 30);
	}
