...
public class AluminumIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:aluminum_ingot")
	public static final Item block = null;
	public AluminumIngotItem(MoreoresModElements instance) {
		super(instance, 3);
	}
