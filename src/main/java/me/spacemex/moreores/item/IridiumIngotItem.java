...
public class IridiumIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:iridium_ingot")
	public static final Item block = null;
	public IridiumIngotItem(MoreoresModElements instance) {
		super(instance, 10);
	}
