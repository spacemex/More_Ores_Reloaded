...
public class PlatinumIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:platinum_ingot")
	public static final Item block = null;
	public PlatinumIngotItem(MoreoresModElements instance) {
		super(instance, 26);
	}
