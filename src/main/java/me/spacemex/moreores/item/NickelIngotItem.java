...
public class NickelIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:nickel_ingot")
	public static final Item block = null;
	public NickelIngotItem(MoreoresModElements instance) {
		super(instance, 22);
	}
