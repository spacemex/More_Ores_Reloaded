...
public class MithrilIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:mithril_ingot")
	public static final Item block = null;
	public MithrilIngotItem(MoreoresModElements instance) {
		super(instance, 18);
	}
