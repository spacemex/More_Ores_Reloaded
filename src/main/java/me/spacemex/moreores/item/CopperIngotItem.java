...
public class CopperIngotItem extends MoreoresModElements.ModElement {
	@ObjectHolder("moreores:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(MoreoresModElements instance) {
		super(instance, 6);
	}
